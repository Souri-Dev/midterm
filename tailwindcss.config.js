...
module.exports = {
  content: ['./public/**/*.html', './templates/**/*.html.twig'], // ✅ includes Twig templates

  darkMode: 'class', // ✅ replaces themeVariants/dark variants
    ...
    plugin(({ addUtilities, theme }) => {
      ...
      Object.entries(colors).forEach(([name, value]) => {
        if (typeof value === 'string') {
          const hsla = Color(value).alpha(0.45).hsl().string()
